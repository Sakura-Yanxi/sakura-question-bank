...
- GitHub Releases 已整理为只保留最新 `v1.0.11`，新用户不会再下载到旧包。
- README、版本更新文档和 Notion 说明同步到当前版本。
...
后端入口是 `app.py`，当前约 `2880` 行。它主要负责启动服务、路由入口和历史 Handler 装配。
